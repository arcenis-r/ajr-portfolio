---
title: "Opening the ML 'Black Box' with Shapley Values - A Tidy Approach"
...
library(kableExtra)   # Just for the Markdown document
```
...
```{r discrete_counts, fig.height=12}
...
```{r num_distributions, fig.height=12}
...
There seems to be less of an interdependence problem among the numeric variables. To deal with this problem in both types of variables I'll use the [recipeselectors::step_mrmr() function](https://stevenpawley.github.io/recipeselectors/reference/step_select_mrmr.html) step in my pre-processing recipe.
